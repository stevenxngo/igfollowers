...
IG Follower Checker is a small personal project determines who on Instagram you follow that doesn't follow you back. 
It comes with a GUI that makes it easy to upload your following and followers, and view the results.
...
open a file dialog. To compare the followers, press the compare button, which will display the usernames of accounts
that you follow that aren't following you back. If any error arise, they will be displayed on the status bar at the
bottom.
